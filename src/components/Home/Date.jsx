...
export default function DateFilter() {
  ...
  return (
    <>
      ...
      >
        {open ? (
          <AiOutlineClear
            ...
            className="bg-pallate1 dark:bg-pallate2 inline w-10 h-10 rounded rounded-tr-none rounded-br-none p-2 z-50"
          />
        ) : (
      ...
      >
        <span className="absolute left-1/2 -translate-x-1/2 text pt-1">
